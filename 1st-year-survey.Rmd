...
newfirst %>% 
  ggplot(newfirst, mapping = aes(x = (factor(compactOp,levels=c("Strongly favorable", "Somewhat favorable", "No opinion", "Somewhat unfavorable", "Strongly unfavorable"))), fill = president))+
  geom_bar(position= "fill") +
...
```{r fig.height=6, fig.width=7, echo = FALSE}
newfirst %>% 
  ggplot(newfirst, mapping = aes(x = (factor(compactOp,levels=c("Strongly favorable", "Somewhat favorable", "No opinion", "Somewhat unfavorable", "Strongly unfavorable"))), fill = (factor(political ,levels=c("Very liberal", "Somewhat liberal", "Moderate","Somewhat conservative", "Very conservative")))))+
  geom_bar(position= "fill") +
...
```{r fig.height=6, fig.width=7, echo = FALSE}
newfirst %>% 
  ggplot(newfirst, mapping = aes(x = primaryvote, fill = (factor(political ,levels=c("Very liberal", "Somewhat liberal", "Moderate","Somewhat conservative", "Very conservative")))))+
  geom_bar(position= "fill") +
...
```{r}
newfirst %>% 
  ggplot(newfirst, mapping = aes(x = jobloss, fill = (factor(president,levels=c("Howie Hawkins", "Jo Jorgenson", "Joe Biden","Donald Trump")))))+
  geom_bar(position= "fill") +
...
newfirst %>% 
  ...
  geom_bar(position= "fill") +
  labs(title = "college and political leaning", 
       x = "", y = "") +
  scale_fill_discrete(name = "political leaning") +
  coord_flip() +
  theme_minimal()
...
```{r fig.height=6, fig.width=7, echo = FALSE}
newfirst %>% 
  ggplot(newfirst, mapping = aes(fill = (factor(political ,levels=c("Very liberal", "Somewhat liberal", "Moderate","Somewhat conservative", "Very conservative"))), x = (factor(wearmask, levels=c("Very likely", "Moderately Likely", "Neither likely or unlikely")))))+
  geom_bar(position= "fill") +
...
```{r fig.height=6, fig.width=7, echo = FALSE}
newfirst %>% 
  ggplot(newfirst, mapping = aes(fill = (factor(political ,levels=c("Very liberal", "Somewhat liberal", "Moderate","Somewhat conservative", "Very conservative"))), x = (factor(usesymmon, levels=c("Very likely", "Moderately Likely", "Neither likely or unlikely", "Moderately unlikely")))))+
  geom_bar(position= "fill") +
...
```{r fig.height=6, fig.width=7, echo = FALSE}
newfirst %>% 
  ggplot(newfirst, mapping = aes(fill = (factor(political ,levels=c("Very liberal", "Somewhat liberal", "Moderate","Somewhat conservative", "Very conservative"))), x = (factor(avoidgather, levels =c("Very likely", "Moderately Likely", "Neither likely nor unlikely","Moderately unlikely", "Very unlikely")))))+
  geom_bar(position= "fill") +
